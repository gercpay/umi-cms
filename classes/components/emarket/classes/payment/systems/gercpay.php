...
/**
 * Class gercpayPayment
 */
class gercpayPayment extends payment
{
    /**
     * @var string[]
     */
    ...
    public function process($template = null)
    {
        ...
        list($templateString) = def_module::loadTemplates("emarket/payment/gercpay/" . $template, "form_block");
    ...
    /**
     * @inheritDoc
     * Receives a request from Gercpay and validates the payment parameters.
